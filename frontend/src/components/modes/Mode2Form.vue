<template>
  <el-form :model="form" label-width="120px">
    ...
    <el-card class="form-card">
      ...
      <el-row :gutter="20">
        <el-col :span="8"><el-form-item label="出口压力 (MPa.G)"><el-input-number v-model="form.hx_cold_out.p_out" :min="-0.1" :step="0.1" /></el-form-item></el-col>
        <el-col :span="8"><el-form-item label="出口温度 (°C)"><el-input-number v-model="form.hx_cold_out.t_out" :min="-273" :step="10" /></el-form-item></el-col>
      </el-row>
    </el-card>
    ...
    <el-card class="form-card">
      ...
      <el-row :gutter="20">
        <el-col :span="6"><el-form-item label="介质"><el-select v-model="form.hx_hot.medium"><el-option label="N₂" value="N2"/><el-option label="O₂" value="O2"/><el-option label="Air" value="Air"/><el-option label="CO₂" value="CO2"/><el-option label="H₂" value="H2"/><el-option label="H₂O" value="H2O"/></el-select></el-form-item></el-col>
        <el-col :span="6"><el-form-item label="流量"><el-input-number v-model="form.hx_hot.flow_rate" :min="0" /><el-select v-model="form.hx_hot.flow_unit" style="width:90px;margin-left:5px;"><el-option label="T/h" value="T/h"/><el-option label="Nm³/h" value="Nm3/h"/></el-select></el-form-item></el-col>
        <el-col :span="6"><el-form-item label="入口压力 (MPa.G)"><el-input-number v-model="form.hx_hot.p_in" :min="-0.1" :step="0.1" /></el-form-item></el-col>
        <el-col :span="6"><el-form-item label="出口压力 (MPa.G)"><el-input-number v-model="form.hx_hot.p_out" :min="-0.1" :step="0.1" /></el-form-item></el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8"><el-form-item label="入口温度 (°C)"><el-input-number v-model="form.hx_hot.t_in" :min="-273" :step="10" /></el-form-item></el-col>
      </el-row>
    </el-card>
...
const form = reactive({
  ...
  hx_hot: { medium_type: 'single', medium: 'Air', flow_rate: 800, flow_unit: 'Nm3/h', p_in: 0.4, p_out: 0.35, t_in: 200 }
})
const submit = async () => {
  loading.value = true
  try {
